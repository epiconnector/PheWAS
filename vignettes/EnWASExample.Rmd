...
xwas = enwas(base_model = lm_str, exposure_vars =  EVs, data_set = jointDF, trans="inv")
...
```{r savestuff}
saveRDS(xwas, file="/HostData/Epiconnector/Data/cycleIexwas.rds")
saveRDS(jointDF, file="/HostData/Epiconnector/Data/cycleIjointdf.rds")
