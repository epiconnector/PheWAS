...
subv = c(agemM[2, c(3,4,2)], mAIC[2], agemM[2, 5:6])
...
subv = c(sexM[2, c(3,4,2)], mAIC[2], sexM[2, 5:6])
names(subv) = names(ftesttable)
...
```{r predictionofAgeSex}
 ##first predict males
  ...
  predVM = predict(lmC, newdata=dfpred1)
  predVMB = predict(lmC, newdata = dfpred1B)
  predVF = predict(lmC, newdata=dfpred2)
   predVFB = predict(lmC, newdata=dfpred2B)
  # lines(40:85, predV)
  plot(31:79, predVF, type="l", xlab="Age", ylab = "Systolic BP", 
       main="Age by Sex Interaction", ylim=c(100,150),lwd=2)
  lines(31:79, predVM, col="skyblue", lwd=2)
