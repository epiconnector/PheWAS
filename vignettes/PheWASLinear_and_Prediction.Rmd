...
# Variable importance
varImpPlot(rf_model, main="Environmental Features Importance  for Race")
...
# Variable importance
varImpPlot(rf_model, main="Environmental Features Importance  for Sex")
...
df_clean <- jointDF[, c("obese", EVs)] |> na.omit()
# Apply inverse normal transformation
df_clean[EVs] <- lapply(df_clean[EVs], function(x) invNorm(x, na.last = "keep", ties.method = "average"))
rf_model <- randomForest(as.factor(obese) ~ ., data = df_clean, importance = TRUE)
print(rf_model)
# Confusion matrix
print(rf_model$confusion)
...
# Variable importance
varImpPlot(rf_model, main="Environmental Features Importance for Obese")
