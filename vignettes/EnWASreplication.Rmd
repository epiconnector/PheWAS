---
title: "EnWAS Replication Study Cycle J"
...
Let's just look at the whole table. We round to three decimal places.
...
Write out the data for subsequent analyses.

```{r savestuff}
saveRDS(xwas, file="/HostData/Epiconnector/Data/cycleJexwas.rds")
saveRDS(jointDF, file="/HostData/Epiconnector/Data/cycleJjointdf.rds")
